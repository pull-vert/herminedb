...
public class SSLTube implements FlowTube {
    ...
    final static class DelegateWrapper implements TubeSubscriber {
        private final TubeSubscriber delegate;
    ...
    final class SSLSubscriberWrapper implements TubeSubscriber {
